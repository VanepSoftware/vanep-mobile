...
- [ ] 4.4 Remover `ProfileMenuId.addresses` (enum, menu CLIENT, `profile_menu_card`, `account_drawer` — o handler saiu da `profile_page`, apagada no PR #69 —, ARB e testes). `rg profileAddresses lib test` vazio.
