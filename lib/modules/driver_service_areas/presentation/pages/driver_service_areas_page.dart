...
class DriverServiceAreasPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(title: Text(l10n.serviceAreasTitle)),
              ...
              children: [
                ...
                if (state.isLoadingAreas)
                  const VanepSkeletonList(
                    count: 2,
                    spacing: 10,
                    buildPlaceholder: buildServiceAreaCardSkeleton,
                  ),
                if (!state.isLoadingAreas && state.isEmpty)
                  Text(
...
Widget buildServiceAreaCardSkeleton(BuildContext context) {
