...
@JsonKey(name: 'access_token') String get accessToken;@JsonKey(name: 'token_type') String get tokenType;@JsonKey(name: 'expires_in') int get expiresInSeconds;@JsonKey(name: 'refresh_token') String? get refreshToken;@JsonKey(name: 'scope') String? get scope;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,accessToken,tokenType,expiresInSeconds,refreshToken,scope);

@override
String toString() {
  return 'TokenResponseDto(accessToken: $accessToken, tokenType: $tokenType, expiresInSeconds: $expiresInSeconds, refreshToken: $refreshToken, scope: $scope)';
}
...
@useResult
$Res call({
@JsonKey(name: 'access_token') String accessToken,@JsonKey(name: 'token_type') String tokenType,@JsonKey(name: 'expires_in') int expiresInSeconds,@JsonKey(name: 'refresh_token') String? refreshToken,@JsonKey(name: 'scope') String? scope
});
...
/// Create a copy of TokenResponseDto
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? accessToken = null,Object? tokenType = null,Object? expiresInSeconds = null,Object? refreshToken = freezed,Object? scope = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(name: 'access_token')  String accessToken, @JsonKey(name: 'token_type')  String tokenType, @JsonKey(name: 'expires_in')  int expiresInSeconds, @JsonKey(name: 'refresh_token')  String? refreshToken, @JsonKey(name: 'scope')  String? scope)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _TokenResponseDto() when $default != null:
return $default(_that.accessToken,_that.tokenType,_that.expiresInSeconds,_that.refreshToken,_that.scope);case _:
  return orElse();
...
class _TokenResponseDto implements TokenResponseDto {
  const _TokenResponseDto({@JsonKey(name: 'access_token') required this.accessToken, @JsonKey(name: 'token_type') required this.tokenType, @JsonKey(name: 'expires_in') required this.expiresInSeconds, @JsonKey(name: 'refresh_token') this.refreshToken, @JsonKey(name: 'scope') this.scope});
  factory _TokenResponseDto.fromJson(Map<String, dynamic> json) => _$TokenResponseDtoFromJson(json);

@override@JsonKey(name: 'access_token') final  String accessToken;
@override@JsonKey(name: 'token_type') final  String tokenType;
@override@JsonKey(name: 'expires_in') final  int expiresInSeconds;
...
/// Create a copy of TokenResponseDto
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? accessToken = null,Object? tokenType = null,Object? expiresInSeconds = null,Object? refreshToken = freezed,Object? scope = freezed,}) {
