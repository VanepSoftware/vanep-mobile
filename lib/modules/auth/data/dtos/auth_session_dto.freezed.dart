...
mixin _$AuthSessionDto {
 ...
 String get accessToken; String get refreshToken; DateTime get expiresAt; UserProfileDto get profile;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,accessToken,refreshToken,expiresAt,profile);

@override
String toString() {
  return 'AuthSessionDto(accessToken: $accessToken, refreshToken: $refreshToken, expiresAt: $expiresAt, profile: $profile)';
}
...
@useResult
$Res call({
 String accessToken, String refreshToken, DateTime expiresAt, UserProfileDto profile
});
...
/// Create a copy of AuthSessionDto
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? accessToken = null,Object? refreshToken = null,Object? expiresAt = null,Object? profile = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String accessToken,  String refreshToken,  DateTime expiresAt,  UserProfileDto profile)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _AuthSessionDto() when $default != null:
return $default(_that.accessToken,_that.refreshToken,_that.expiresAt,_that.profile);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String accessToken,  String refreshToken,  DateTime expiresAt,  UserProfileDto profile)  $default,) {final _that = this;
switch (_that) {
case _AuthSessionDto():
return $default(_that.accessToken,_that.refreshToken,_that.expiresAt,_that.profile);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String accessToken,  String refreshToken,  DateTime expiresAt,  UserProfileDto profile)?  $default,) {final _that = this;
switch (_that) {
case _AuthSessionDto() when $default != null:
return $default(_that.accessToken,_that.refreshToken,_that.expiresAt,_that.profile);case _:
  return null;
...
class _AuthSessionDto implements AuthSessionDto {
  const _AuthSessionDto({required this.accessToken, required this.refreshToken, required this.expiresAt, required this.profile});
...
/// Create a copy of AuthSessionDto
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? accessToken = null,Object? refreshToken = null,Object? expiresAt = null,Object? profile = null,}) {
